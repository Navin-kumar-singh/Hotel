            ...
            <div className='relative flex flex-col items-center md:w-1/2 p-8 md:p-10'>
                <img src={assets.closeIcon} alt="close-icon" className='absolute top-4 right-4
                 ...
                 <div className='w-full mt-4'>
                    ...
                    <input id="contact" type="number" placeholder='Type here' className='border border-gray-200 rounded  w-full px-3 py2.5 mt-1 outline-indigo-500 font-light' required />
                 </div>
                 <div className='w-full mt-4'>
                    <label htmlFor="address" className='font-medium text-gray-500'>address</label>
                    <input id='address' type="address" placeholder='Type here' className='border border-gray-200 rounded  w-full px-3 py2.5 mt-1 outline-indigo-500 font-light' required />
                 </div>
                 {/* drop down */}
