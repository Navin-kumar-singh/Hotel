...
const Dashboard = () => {
    ...
    return (
        <div className=''>
            <Title align='left' font='outfit' title='Dashboard' subTitle='Monitor your room listing, track  booking and analyze revenue-all in one place. Stay
                ...
                <table className='w-full'>
                    ...
                    <tbody className='text-sm'>
                        {dashboardData.bookings.map((item, index)=>(
                            <tr key={index}>
                                <td className='py-4 px-4 text-gray-700 border-gray-300'>
                                    {item.user.username}
                                </td>
                                   <td className='py-4 px-4 text-gray-700 border-gray-300 max-sm:hidden'>
                                    {item.room.roomType}
                                </td>
