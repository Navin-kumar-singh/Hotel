...
const MyBooking = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
            <Title title=' My Booking ' subTitle=' Easily mange your past, current and upcomming hotel reservations in one place. Plane your trips seamless with just a few clicks ' align='left' />
            <div className=' max-w-6xl mt-8 w-full text-gray-800'>
                <div className=' hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full bordre-b border-gray-300 font-medium py-3'>
                ...
                {bookings.map((booking) => (
                    <div key={booking._id} className=' grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                        ...
                        <div className='flex flex-col md:flex-row'>
                            ...
                            <div className='flex flex-col rounded shadow object-cover'>
